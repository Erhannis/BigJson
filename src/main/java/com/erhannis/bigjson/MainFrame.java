...
public class MainFrame extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        btnLoadString = new javax.swing.JButton();
        btnSaveString = new javax.swing.JButton();
        ...
        btnLoadString.setText("Load string");
        btnLoadString.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnLoadStringActionPerformed(evt);
            }
        });

        btnSaveString.setText("Save string");
        btnSaveString.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSaveStringActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnLoadString)
                    .addComponent(btnSaveString))
  ...
  private void btnFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindActionPerformed
    ...
    private void btnLoadStringActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadStringActionPerformed
        int[] sels = jList1.getSelectedIndices().clone();
        if (sels.length > 0) {
          JsonStringWrapper wrap = jList1.getSelectedValue();
          if (wrap.obj instanceof String) {
              try {
                  load((String)wrap.obj);
              } catch (ParseException ex) {
                  Logger.getLogger(MainFrame.class.getName()).log(Level.SEVERE, null, ex);
              }
          } else {
              System.err.println("Selection is not a string; is a " + (wrap.obj == null ? null : wrap.obj.getClass()));
          }
        }
    }//GEN-LAST:event_btnLoadStringActionPerformed

    private void btnSaveStringActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveStringActionPerformed
        int[] sels = jList1.getSelectedIndices().clone();
        if (sels.length > 0) {
          JsonStringWrapper wrap = jList1.getSelectedValue();
          if (wrap.obj instanceof String) {
    ...
    }//GEN-LAST:event_btnSaveStringActionPerformed
  ...
  private void load(String json) throws ParseException {
    JSONObject obj;
...
//                    target.add(o2);
  ...
  public static void main(String args[]) {
    ...
    private javax.swing.JButton btnLoadString;
    private javax.swing.JButton btnRelayer;
    private javax.swing.JButton btnRetab;
    private javax.swing.JButton btnSave;
    private javax.swing.JButton btnSaveString;
